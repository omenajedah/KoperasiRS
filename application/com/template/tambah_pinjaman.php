...
<div class="d-flex justify-content-between">
	...
	<div class="d-flex h1">Tambah Pinjaman</div>
	<a href="/koperasi/pinjaman" class="btn btn-primary align-self-center disabled invisible"><i class="icon-arrow-left"></i> Daftar Pinjaman</a>
</div>
<br>
<div class="tab-pane" id="formcontrols">
	<form id="edit-profile" class="form-horizontal" action="" method="post">
		<fieldset>
			...
			<div class="form-group">
				<label class="control-label" for="jenis">Jenis Pinjaman</label>
				<select class="form-control" name="kd_jp" id="jenis" onchange="ch(this.value)">
					<option value="">--PILIH--</option>
					<?php
					...
					foreach ($on as $k => $ra) {
						$ra = (object) $ra;
					?>
					<option value="<?php echo $ra->kd_jp; ?>"><?php echo $ra->nama_jp; ?></option>
					<?php } ?>
				</select>
			</div> <!-- /form-group -->

			<div class="form-group">
				<label class="control-label" for="bunga">Jasa</label>
				<input type="text" class="form-control" name="bunga" id="bunga" required readonly>
			</div> <!-- /form-group -->

			<div class="form-group">
				<label class="control-label" for="totalS">Total Pinjaman</label>
				<input type="text" class="form-control" name="total_pinjaman" id="totalS" required>
			</div> <!-- /form-group -->
			...
			<div class="form-group">
				<label class="control-label" for="totalT">Total Transaksi</label>
